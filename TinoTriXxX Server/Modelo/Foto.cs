                ...
                try
                {
                    ...
                    foreach (DataRow item in Conexionhost.Busquedas(comando).Rows)
                    {
                        foto = new Foto()
                        {
                            ...
                            StrPrecioTicket = item["VchPrecioTicket"].ToString(),
                            IntAlto =  double.Parse(item["VchAlto"].ToString(), ni),
                            IntAncho = double.Parse(item["VchAncho"].ToString(), ni),
                            IntAltoDesc = double.Parse(item["VchAltoDesc"].ToString(), ni),
                            IntAnchoDesc = double.Parse(item["VchAnchoDesc"].ToString(), ni),
                            ...
                            StrDescripcionDetalle ="$ " + item["VchPrecioTicket"].ToString()+ " c/u ( "+ item["VchAnchoDesc"].ToString()+" x "+ item["VchAltoDesc"].ToString()+" " + item["VchMedida"].ToString()+ " ) "
