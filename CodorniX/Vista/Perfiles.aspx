<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Perfiles.aspx.cs" MasterPageFile="Site1.Master" Inherits="CodorniX.Vista.Perfiles" %>
                        ...
                        <asp:Panel ID="PanelFiltros" runat="server">
                            <div class="col-md-12">
                                <div class="col-md-4">
                                 ...
                                 <div class="col-md-4">
                                    <h6>Nivel de Acceso</h6>
                                    <asp:ListBox ID="lblNivelAcceso" runat="server" SelectionMode="Multiple" CssClass="form-control" />
                                </div>
                            </div>
                            <div class="col-md-12">
                                <br />
                        ...
                        <div style="padding-top: 25px">
                            <asp:GridView ID="DVGPerfiles" AllowPaging="true" PageSize="10" OnPageIndexChanging="DVGPerfiles_PageIndexChanging" OnSelectedIndexChanged="DVGPerfiles_SelectedIndexChanged" OnSorting="DVGPerfiles_Sorting" OnRowDataBound="DVGPerfiles_RowDataBound" AutoGenerateColumns="false" DataKeyNames="UidPerfil" CssClass="table table-bordered table-condensed table-striped input-sm" AllowSorting="true" runat="server">
                                ...
                                <Columns>
                                   ...
                                   <asp:BoundField DataField="StrNivelAcceso" HeaderText="Nivel Acceso" SortExpression="NivelAcceso" />
                                </Columns>
                            </asp:GridView>
                        </div>
                    </div>
        ...
        <div class="col-md-6">
            <div class="panel panel-primary">
                ...
                <div class="text-left">
                    ...
                    <asp:TextBox CssClass="hide" ID="txtempresa" runat="server" />
                </div>
                ...
                <div class="panel-body">
                    ...
                    <asp:PlaceHolder ID="panelGestiondePerfiles" runat="server">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <h6>Nivel</h6>
                                <asp:DropDownList ID="DdNivel" CssClass="form-control" runat="server">
                                </asp:DropDownList>
                            </div>
                        </div>
                    </asp:PlaceHolder>
